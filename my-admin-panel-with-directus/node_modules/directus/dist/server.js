...
async function createServer() {
    ...
    server.on('request', function (req, res) {
        ...
        const complete = (0, lodash_1.once)(function (finished) {
            ...
            (0, emitter_1.emitAsyncSafe)('response', info);
        });
    ...
    async function beforeShutdown() {
        (0, emitter_1.emitAsyncSafe)('server.stop.before', { server });
    ...
    async function onShutdown() {
        (0, emitter_1.emitAsyncSafe)('server.stop');
        if (env_1.default.NODE_ENV !== 'development') {
...
async function startServer() {
    ...
    server
        ...
        (0, emitter_1.emitAsyncSafe)('server.start');
    })
        .once('error', (err) => {
