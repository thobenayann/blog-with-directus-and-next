    ...
    async createMany(data, opts) {
        ...
        for (const user of data) {
            if (user.provider !== undefined) {
                throw new exceptions_2.InvalidPayloadException(`You can't set the "provider" value manually.`);
            }
            if (user.external_identifier !== undefined) {
                throw new exceptions_2.InvalidPayloadException(`You can't set the "external_identifier" value manually.`);
            }
        }
