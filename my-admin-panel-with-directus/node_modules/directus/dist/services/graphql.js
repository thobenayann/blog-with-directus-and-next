...
class GraphQLService {
    ...
    getSchema(type = 'schema') {
        ...
        const schema = {
            read: ((_a = this.accountability) === null || _a === void 0 ? void 0 : _a.admin) === true ? this.schema : (0, reduce_schema_1.reduceSchema)(this.schema, ['read']),
            create: ((_b = this.accountability) === null || _b === void 0 ? void 0 : _b.admin) === true ? this.schema : (0, reduce_schema_1.reduceSchema)(this.schema, ['create']),
            update: ((_c = this.accountability) === null || _c === void 0 ? void 0 : _c.admin) === true ? this.schema : (0, reduce_schema_1.reduceSchema)(this.schema, ['update']),
            delete: ((_d = this.accountability) === null || _d === void 0 ? void 0 : _d.admin) === true ? this.schema : (0, reduce_schema_1.reduceSchema)(this.schema, ['delete']),
        };
                    ...
                    fields: Object.values(collection.fields).reduce((acc, field) => {
                        ...
                        acc[field.field] = {
                            ...
                            resolve: (obj, _, __, info) => {
                                var _a, _b;
                                return obj[(_b = (_a = info === null || info === void 0 ? void 0 : info.path) === null || _a === void 0 ? void 0 : _a.key) !== null && _b !== void 0 ? _b : field.field];
                            },
                        };
                        if (field.type === 'date') {
            ...
            for (let selection of selections) {
                ...
                // Any other field type
                    ...
                    if (selection.name.value.startsWith('__'))
                        continue;
                    current = (_b = (_a = selection.alias) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : selection.name.value;
                    if (parent) {
    ...
    getAggregateQuery(rawQuery, selections) {
        ...
        for (let aggregationGroup of selections) {
            ...
            query.aggregate[aggregateProperty] =
                (_b = (_a = aggregationGroup.selectionSet) === null || _a === void 0 ? void 0 : _a.selections.map((selectionNode) => {
