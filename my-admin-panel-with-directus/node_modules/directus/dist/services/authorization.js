...
class AuthorizationService {
    ...
    async processAST(ast, action = 'read') {
        ...
        const permissionsForCollections = (0, lodash_1.uniqWith)(this.schema.permissions.filter((permission) => {
        ...
        function applyFilters(ast, accountability) {
            ...
            function updateFilterQuery(collection, query) {
                // We check the availability of the permissions in the step before this is run
                const permissions = permissionsForCollections.find((permission) => permission.collection === collection);
                const parsedPermissions = (0, utils_1.parseFilter)(permissions.permissions, accountability);
    ...
    validatePayload(action, collection, data) {
        ...
        const preset = (0, utils_1.parseFilter)(permission.presets || {}, this.accountability);
        const payloadWithPresets = (0, lodash_1.merge)({}, preset, payload);
        const hasValidationRules = (0, lodash_1.isNil)(permission.validation) === false && Object.keys((_c = permission.validation) !== null && _c !== void 0 ? _c : {}).length > 0;
        const requiredColumns = [];
        for (const field of Object.values(this.schema.collections[collection].fields)) {
            const specials = (_d = field === null || field === void 0 ? void 0 : field.special) !== null && _d !== void 0 ? _d : [];
        ...
        validationErrors.push(...(0, lodash_1.flatten)((0, utils_1.validatePayload)((0, utils_1.parseFilter)(permission.validation, this.accountability), payloadWithPresets).map((error) => error.details.map((details) => new exceptions_2.FailedValidationException(details)))));
