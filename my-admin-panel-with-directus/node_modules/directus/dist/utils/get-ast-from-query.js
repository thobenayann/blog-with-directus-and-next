...
async function getASTFromQuery(collection, query, schema, options) {
    ...
    if (!query.sort) {
        ...
        if ((_a = schema.collections[collection]) === null || _a === void 0 ? void 0 : _a.sortField) {
        ...
        if ((_b = query.group) === null || _b === void 0 ? void 0 : _b[0]) {
    ...
    if (query.aggregate && Object.keys(query.aggregate).length && !((_c = query.group) === null || _c === void 0 ? void 0 : _c[0])) {
        delete query.sort;
    }
